...
public class DoubleSetApp {
    ...
    public static ISet<Double> M1;
    public static ISet<Double> M2;
     ...
     */
    public static void makeMenu(ISet<Double> M) {
        Scanner scan = new Scanner(System.in);
        String s = "";
